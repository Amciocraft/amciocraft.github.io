...
<head>';
	...
	// my custom jquery bits
		echo '<script type="text/javascript" src="', $settings['theme_url'], '/scripts/jquery_bits.js"></script>';
		
	// Stuff for the lavalamp menu
	echo '
...
';
					...
					{
						echo '
							', $txt['vp_welcome_guest'] ,' <a href="', $scripturl ,'?action=login">', $txt['vp_login'] ,'</a> ', $txt['vp_or'] ,' <a href="', $scripturl ,'?action=register">', $txt['vp_register'] ,'</a>.
						';
					}
echo '		
				</div>
...
echo '
	...
	<div class="header_main">
		<div class="header_main_content" style="width: ' . $settings['forum_width'] . '">
					...
					<div class="quick_search">
						<div class="quick_search_content">
							...
							<div class="quick_search_context">
								<div id="quick_search_context_choice">Forum</div>
';
								echo '
								<div class="quick_search_context_options">
									<ul class="quick_search_context_options_ul">
										<li>
											<div class="quick_search_context_item" title="Forum">
												<label for="qs_forums">
													<input class="quick_search_context_item_input" type="radio" id="qs_forums" name="quick_search_context" value="forums" checked="checked" /> Forum
												</label>
											</div>
										</li>
								';
										...
										if (!empty($context['current_board']))
										{
											echo '
											<li>
												<div class="quick_search_context_item" title="Działy">
													<label for="qs_boards">
														<input class="quick_search_context_item_input" type="radio" id="qs_boards" name="brd[', $context['current_board'], ']" value="', $context['current_board'], '" /> Dział
													</label>
												</div>
											</li>
											';
										...
										if (!empty($context['current_topic']))
										{
											echo '
											<li>
												<div class="quick_search_context_item" title="Tematy">
													<label for="qs_topics">
														<input class="quick_search_context_item_input" type="radio" id="qs_topics" name="topic" value="', $context['current_topic'], '" /> Temat
													</label>
												</div>
											</li>
											';
...
echo '
	...
	<div class="header_nav">
		<div class="header_nav_content" style="width: 89%;">
';
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li class="copyright"><a href="http://visualpulse.net/">', $txt['mlm_copyright'] ,'</a> edit by <a href="http://tcgforum.pl/forum/">Tpk-Games</a></li>
		</ul>';
