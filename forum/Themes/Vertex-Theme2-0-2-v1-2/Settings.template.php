...
function template_settings()
{
	...
	'',
		array(
			'id' => 'social_icons_present',
			'label' => $txt['social_icons_present'],
			'description' => $txt['social_icons_present_description'],
		),
		array(
			'id' => 'social_icon_facebook_url',
			'label' => $txt['social_icon_facebook_text'],
			'type' => 'text',
		),
		array(
			'id' => 'social_icon_twitter_url',
			'label' => $txt['social_icon_twitter_text'],
			'type' => 'text',
		),
	);
}
